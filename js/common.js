...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	const $wrapper = $(this);
	const $slider = $wrapper.find('.slider-etaps');
	const $number = $wrapper.find('.slider-counter__current');
	const $total = $wrapper.find('.slider-counter__total');
	const $arrows = $wrapper.find('.slider-controls__arrows');
	...
	const $wrapper = $(this);
	const $slider = $wrapper.find('.slider-documents');
	const $number = $wrapper.find('.slider-counter__current');
	const $total = $wrapper.find('.slider-counter__total');
	const $arrows = $wrapper.find('.slider-controls__arrows');
	...
	$('.slider-wrapper-reviews').each(function () {
	const $wrapper = $(this);
	const $slider = $wrapper.find('.slider-reviews');
	const $number = $wrapper.find('.slider-counter__current');
	const $total = $wrapper.find('.slider-counter__total');
	const $arrows = $wrapper.find('.slider-controls');
